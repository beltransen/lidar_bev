...
int grid_dim, grid_dim_height_map, ground_cell_span;
...
int main(int argc, char *argv[])
{
    ...
    public_nh.param("grid_dim", grid_dim, 1000);
    public_nh.param("/lidar_bev/grid_dim", grid_dim, 1000);
    private_nh.param("grid_dim_height_map", grid_dim_height_map, 300);
    private_nh.param("low_opening", low_opening, 24.9); //-24.9 for 64 layers
    private_nh.param("v_res", v_res, 0.4); //0.4 for 64 layers
